...
```console
shell# ./scripts/install-sd-5.10.120-zynqmp-fpga-generic.sh -v -t Ultra96-V2 -b /mnt/usb1 -r /mnt/usb2
...
echo '/dev/mmcblk0p1    /mnt/boot       auto            defaults        0       0' >> /mnt/usb2/etc/fstab
...
#### Boot Ultra96-V2 and login fpga or root user
