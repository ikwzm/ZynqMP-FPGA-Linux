...
* target/Ultra96-V2/build-v2019.1/
  - fpga/
    + create_project.tcl
    + design_1_bd.tcl
    + implementation.tcl
...
```console
shell$ cd target/Ultra96-V2/build-v2019.1/fpga
...
```console
vivado% cd target/Ultra96-V2/build-v2019.1
...
```console
shell$ cd target/Ultra96-V2/build-v2019.1
