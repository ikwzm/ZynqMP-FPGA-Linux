...
* target/Ultra96-V2/build-v2019.2/
  - fpga/
    + create_project.tcl
    + design_1_bd.tcl
    + implementation.tcl
...
```console
shell$ cd target/Ultra96-V2/build-v2019.2/fpga
...
```console
vivado% cd target/Ultra96-V2/build-v2019.2
...
```console
shell$ cd target/Ultra96-V2/build-v2019.2
